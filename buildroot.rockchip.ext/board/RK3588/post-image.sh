...
cp -a $BR2_EXTERNAL_RK3588_PATH/board/RK3588/vars.txt $BINARIES_DIR/
...
$ubootName/tools/mkimage -C none -A arm -T script -n 'flatmax load script' -d $BR2_EXTERNAL_RK3588_PATH/board/RK3588/boot.cmd $BINARIES_DIR/boot.scr
#
...
$BASE_DIR/../support/scripts/genimage.sh -c $BR2_EXTERNAL_RK3588_PATH/board/RK3588/genimage.cfg
